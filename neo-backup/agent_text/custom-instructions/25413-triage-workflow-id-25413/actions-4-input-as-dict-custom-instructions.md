...
Set "AI Eligibility" UDF = Ineligible 



Escalation Criteria: 

Automatically escalate ticket if UDF 'AI Eligibility'  is determined to be 'Ineligible' during this Triage Run

OR 

Escalate the ticket if the requests matches one of the following criteria rules:  
```
TRIGGER_ID_017  
...
Exclusion: Do not match a Bluebeam end-user installation/support request, including "Bluebeam account setup," unless it expressly requests a quote, purchase, new paid license, subscription, or renewal.
