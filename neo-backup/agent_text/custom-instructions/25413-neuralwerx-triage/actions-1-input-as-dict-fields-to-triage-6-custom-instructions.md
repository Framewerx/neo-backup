...
QUEUE RULES
- 100 SD-Issues: reactive break-fix, user technical issues, troubleshooting, general incidents, Fortinet SOC malware detections, printer additions, key/fob replacement, user-reported phishing/spam, RocketCyber reports, voicemail messages, Questions or Inquiries regarding EDR or other Security Applications (Including MacAfee)   
