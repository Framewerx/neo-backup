...
- Always route to PS department if all of the following are true: 
    - Work Type = 400 Add/Move/Change 
    - Estimated Hours > 1 hour 
    - Queue is in 400 - 499 range 
- Always route to Service Desk Team if all of the following are true: 
    - Work Type = 400 Add/Move/Change 
    - Estimated Hours < 1 hour 
    - Queue is in 100 - 297 range 

# HY’s Steak House routing

- When company is HY’s Steak House and the queue is in the 100 or 200 queue ranges (e.g. 100 SD‑Issues, 110 SD‑Access, 200 CS‑Routine, 205 CS‑Problem, 210 CS‑Monitoring Alert, 220 CS‑Security, 299 CS‑Automation):
    - Set the ticket’s primary resource to Kim David Camaongay.
    - Do not override the existing rule for queue 700 / category 700 → Michelle Ronnenkamp.
    - Do not remove existing secondary resources.
- For these HY’s tickets (100/200 ranges), always add Mike Lee as an additional contact if he is not already listed.
